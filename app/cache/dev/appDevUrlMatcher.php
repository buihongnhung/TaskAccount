    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            if (0 === strpos($pathinfo, '/ad')) {
                // adminpage
                if ($pathinfo === '/admin') {
                    return array (  '_controller' => 'Account\\AccountBundle\\Controller\\AdminController::adminAction',  '_route' => 'adminpage',);
                }

                // adminaddgroup
                if ($pathinfo === '/addgroup') {
                    return array (  '_controller' => 'Account\\AccountBundle\\Controller\\AdminController::addGroupAction',  '_route' => 'adminaddgroup',);
                }

                if (0 === strpos($pathinfo, '/admin')) {
                    // adminupdate
                    if (0 === strpos($pathinfo, '/admin/update') && preg_match('#^/admin/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'adminupdate')), array (  '_controller' => 'Account\\AccountBundle\\Controller\\AdminController::editAction',));
                    }

                    // admindelete
                    if (0 === strpos($pathinfo, '/admin/delete') && preg_match('#^/admin/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admindelete')), array (  '_controller' => 'Account\\AccountBundle\\Controller\\AdminController::deleteAction',));
                    }
            ...
            // homepage
            if ($pathinfo === '/account') {
                return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepage',);
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'homepagex');
            }

            return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::indexAction',  '_route' => 'homepagex',);
        }
        ...
        if (0 === strpos($pathinfo, '/account')) {
            if (0 === strpos($pathinfo, '/account/log')) {
                ...
                if ($pathinfo === '/account/login') {
                    return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::loginAction',  '_route' => 'login',);
                }

                // logout
                if ($pathinfo === '/account/logout') {
                    return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::logoutAction',  '_route' => 'logout',);
                }
            ...
            if ($pathinfo === '/account/register') {
                return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::registerAction',  '_route' => 'register',);
            }

            // changepassword
            if ($pathinfo === '/account/changepassword') {
                return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::changepasswordAction',  '_route' => 'changepassword',);
            }

            // resetpassword
            if ($pathinfo === '/account/resetpassword') {
                return array (  '_controller' => 'Account\\AccountBundle\\Controller\\DefaultController::resetpasswordAction',  '_route' => 'resetpassword',);
            }
