...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user.provider.entity.secured_area' => 'my_user_provider',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'account', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Account\\AccountBundle\\Resources\\config\\doctrine') => 'Account\\AccountBundle\\Entity'));
        ...
        $c->addDriver($a, 'Account\\AccountBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AccountBundle' => 'Account\\AccountBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_34a69aac7ad9b725b0d74788407a5143fbed1e10dcf075f9f68d9b47e96edf8c');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Account\\AccountBundle\\Entity\\Account');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Account\\AccountBundle\\Entity\\Account');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Account\\AccountBundle\\Entity\\Account');
    }
    ...
    protected function getHwiOauth_ResourceOwner_FacebookService()
    {
        ...
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($a, $this->get('security.http_utils'), array('client_id' => '1548965112044940', 'client_secret' => '3fcbf6954527f42e7f0d1cb7df34b907', 'scope' => 'email,public_profile,user_friends', 'options' => array('display' => 'page'), 'paths' => array()), 'facebook', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.secured_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'facebook'), array('facebook' => '/login/check-facebook'));
        $instance->setContainer($this);
        return $instance;
    }
    ...
    {
        return $this->services['my_user_provider'] = new \Account\AccountBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('hwi_oauth.user.provider'), 1 => $this->get('fos_user.user_provider.username_email'), 2 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        $l = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $f, $g, $d, 'main', $j, $k, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $b, $c);
        $l->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $l->setCheckPaths(array(0 => '/login/check-facebook'));
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('hwi_oauth.user.provider'), 1 => $this->get('fos_user.user_provider.username_email'), 2 => $this->get('security.user.provider.concrete.in_memory')), 'main', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $g, $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 3 => $l, 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($d, '/login'), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($this->get('http_kernel'), $d, array(), $b);
        $g->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
        $h = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $e, $this->get('security.authentication.session_strategy'), $d, 'secured_area', $f, $g, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $b, $c);
        $h->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.secured_area'));
        $h->setCheckPaths(array(0 => '/login/check-facebook'));
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('hwi_oauth.user.provider'), 1 => $this->get('fos_user.user_provider.username_email'), 2 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5501c8cf19a90', $b, $e), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($d, '/login'), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('steambot00001@gmail.com');
        $a->setPassword('asdwasdq');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Account\\AccountBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Account\\AccountBundle/Resources/views'), 'Account');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6c45462c2e5dff1a349f02a23d1ae5268b6935d7');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = $this->get('my_user_provider');
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('hwi_oauth.user.provider'), $a, 'demo_secured_area', $b, true), 1 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($c, $this->get('hwi_oauth.resource_ownermap.secured_area'), $a), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5501c8cf19a90'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username_email'), $a, 'main', $b, true), 4 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($c, $this->get('hwi_oauth.resource_ownermap.main'), $a)), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AccountBundle' => 'Account\\AccountBundle\\AccountBundle',
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'steambot00001@gmail.com',
            'mailer_password' => 'asdwasdq',
            'locale' => 'en',
            'secret' => '6c45462c2e5dff1a349f02a23d1ae5268b6935d7',
            ...
            'kernel.secret' => '6c45462c2e5dff1a349f02a23d1ae5268b6935d7',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'steambot00001@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'asdwasdq',
            ...
            'fos_user.model.user.class' => 'Account\\AccountBundle\\Entity\\Account',
