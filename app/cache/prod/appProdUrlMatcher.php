...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/loginfb')) {
            ...
            if (0 === strpos($pathinfo, '/loginfb/service') && preg_match('#^/loginfb/service/(?P<service>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/loginfb/registration') && preg_match('#^/loginfb/registration/(?P<key>[^/]++)$#s', $pathinfo, $matches)) {
